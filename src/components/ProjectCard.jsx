        ...
        <div className="flex max-lg:flex-col items-center ">
            <div className="border dark:border-secondary_black px-8 py-16 max-[460px]:py-6 w-1/2 max-lg:w-full bg-gray-100/50 dark:bg-secondary_black shadow-2xl float-left flex flex-col gap-6 text-center rounded">
                ...
                <div className="mb-8 flex flex-wrap gap-4 justify-center">
                    <a href={url} target="_blank" className={`px-4 py-2 bg-gradient-to-r ${gradient} text-xs text-primary_white rounded-full hover:-translate-y-1 inline-block transition`}> <FaEye className="inline" /> Live Demo </a> 
                    <a href={codeUrl} target="_blank" className={`px-4 py-2 bg-gradient-to-r ${gradient} text-xs text-primary_white rounded-full hover:-translate-y-1 inline-block transition`}> <FaCode className="inline" /> Code </a> 
                </div>
                <span className="text-gray-800/50 dark:text-gray-400 text-xs">{builtWith}</span>          
            </div>
